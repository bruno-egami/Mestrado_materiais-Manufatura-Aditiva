...
\begin{document}
	...
	\begin{frame}{O Desafio da Manufatura Aditiva de Cerâmicas}
		\begin{itemize}
			...
			\begin{itemize}
				\item \textbf{Ligantes (Binders):} Exigem \textit{de-binding} térmico, causando retração irregular e rachaduras.
	...
	\begin{frame}{Otimização Reológica para o DIW}
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{itemize}
					\item A tinta ideal deve ser \textbf{\textit{shear-thinning}} para extrusão suave.
				...
				\begin{itemize}
					...
					\item \textbf{Resultado:} A tinta com \textbf{60 wt\% SiC} mostrou excelente retenção, superando o limite.
				\end{itemize}
	...
	\begin{frame}{Transformação de Fase e Retração}
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{itemize}
					\item \textbf{Pós-Processamento:} Sinterizadas a $1500^\circ\text{C}$ e $2300^\circ\text{C}$.
